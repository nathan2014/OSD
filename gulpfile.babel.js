...
gulp.task('server', ['build'], () => {
    ...
    $.watch('static/fonts/**/*', () => gulp.start('css'))
    $.watch('static/css/**/*', () => gulp.start('css'))
    $.watch('static/js/**/*.js', () => gulp.start('js-watch'))
    $.watch('static/images/**/*', () => gulp.start('images'))
    $.watch(['archetypes/**/*', 'data/**/*', 'content/**/*', 'layouts/**/*', 'static/**/*', 'config.toml'], () => gulp.start('hugo'))
});

gulp.task('build', () => {
    runSequence([ 'js', 'fonts', 'images'], 'hugo')
})

gulp.task('build-preview', () => {
    runSequence([ 'js', 'fonts', 'images'], 'hugo-preview')
})
